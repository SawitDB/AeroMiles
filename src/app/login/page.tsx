...
export default function LoginPage() {
  ...
  return (
    <main className="flex min-h-screen items-center justify-center p-6">
      <div className="w-full max-w-sm rounded-2xl bg-white/6 p-6 shadow-sm">
        <h1 className="text-center text-2xl font-semibold text-white">AEROMILES</h1>
        <p className="mt-2 text-center text-sm text-white/80">Silakan masuk ke akun Anda</p>
        ...
        <form className="mt-6 space-y-4" onSubmit={handleSubmit}>
          <div>
            ...
            <input
              ...
              className="mt-1 w-full rounded-xl border border-white/10 bg-transparent px-4 py-3 text-sm text-white outline-none focus:border-primary focus:ring-2 focus:ring-primary/20"
            />
          </div>
          ...
          <div className="flex gap-3">
            ...
            <Link href="/register" className="inline-flex items-center gap-2 rounded-xl border border-white/10 px-4 py-3 text-sm font-semibold text-white">
              Registrasi
            </Link>
          </div>
        </form>
